    ...
    <section className="py-40 bg-[#050505] relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 text-center relative z-10 space-y-12">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6 pt-6">
          <button className="px-12 py-5 bg-[#D4AF37] text-[#050505] font-bold uppercase tracking-widest text-xs transition-all hover:scale-105 hover:shadow-[0_0_30px_rgba(212,175,55,0.5)]">
            Start a Conversation
          </button>
          <button className="px-12 py-5 border border-white/20 text-white font-bold uppercase tracking-widest text-xs transition-all hover:bg-white/10 hover:scale-105">
            Download Prospectus
          </button>
        </div>
      </div>
